package com.kalby.healthmonitoring.aop;
...
public class LogAspect {
    ...
    /**
     * 定义切点，此切点匹配com.kalby.healthmonitoring.controller包及其子包下所有public方法的执行。
     */
    @Pointcut("execution(public * com.kalby.healthmonitoring.controller..*.*(..))")
