...
import com.kalby.healthmonitoring.dto.conversation.MessageDTO;
...
public class ConversationService {
     ...
     */
    private MessageDTO convertToMessageDto(com.kalby.healthmonitoring.model.domain.MessageDO message) {
